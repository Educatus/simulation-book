...
The next step is to evaluate the goodness-of-fit test statistics presented in Table @tbl-fitteststats. They measure the distance between the empirical and fitted CDF.
...
4.  Repeat for other query points $x$ from 3 to 10 and plot the KDE.
...
::: {#fig-KDEfigures}
![](graphics/KDEforH.png){width=100% alt="Kernel density graphs for the example."}
